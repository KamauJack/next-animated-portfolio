  ...
  return (
    ...
    >
      ...
      <div className="h-full lg:flex overflow-scroll" ref={containerRef}>
        {/*TEXT CONTAINER */}
        <div className="lg:w-2/3 xl:1/2 lg:pr-0 p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24  md:gap-32  lg:gap-48 xl:gap-64">
          {/* BIOGRAPHY CONTAINER */}
          <div className="flex flex-col gap-12 justify-center">
            <h1 className="font-bold text-2xl">BIOGRAPHY </h1>
            <p className="text-lg">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi
              molestias officia vero nihil adipisci possimus vitae obcaecati.
              Sit harum voluptatibus corporis expedita tenetur ea velit modi
              eveniet delectus, architecto distinctio ipsam molestiae quibusdam
              necessitatibus aliquam cupiditate dolorum consequuntur, deserunt
              animi labore iure quidem autem. Dolorum perspiciatis esse quis ad
              soluta?
            </p>
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between h-48">
                {/* LEFT */}
                <div className="w-1/3 "></div> {/* CENTER */}
                <div className="w-1/6 flex justify-center">
                  {/* LINE */}
                  <div className="w-1 h-full bg-gray-600 rounded relative">
                    {/* LINE CIRCLE */}
